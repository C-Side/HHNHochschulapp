...
public class LindaTutorial1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Notenspiegel anzeigen Tutorial");
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(getArguments().getInt(ARG_SECTION_NUMBER)==1){
                ...
                View rootView = inflater.inflate(R.layout.fragment_linda_tutorial1_2, container, false);
                return rootView;
            }else if (getArguments().getInt(ARG_SECTION_NUMBER)==3){

                View rootView = inflater.inflate(R.layout.fragment_linda_tutorial1_3, container, false);
                return rootView;
